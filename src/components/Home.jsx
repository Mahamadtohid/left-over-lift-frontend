  ...
  const faqs = [
    {
      ...
      answer: "We partner with certified vendors and implement strict food safety protocols. All food items are properly labeled with expiration dates and storage requirements. Our community rating system helps maintain quality standards."
    },
    {
      question: "What types of food can I donate or find?",
      answer: "You can donate or find a wide variety of food including fresh produce, bakery items, prepared meals, packaged goods, and more. All items must be properly sealed and within safe consumption dates."
    },
    {
      question: "How do payments work on the platform?",
      answer: "We use secure payment processing with multiple options including credit cards, digital wallets, and in-app payments. All transactions are protected and you can track your payment history in your account."
    },
    {
      question: "Is LeftOverLift available in my city?",
      answer: "We're rapidly expanding across the country. Check our coverage map or enter your location to see if we're available in your area. We're adding new cities every month!"
    }
  ];
    ...
    <div className="w-full relative min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50 font-poppins overflow-hidden">
      ...
      <section className="hero-section relative min-h-screen flex items-center justify-center px-6 md:px-20 py-16">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Left Content */}
          <div className={`hero-content space-y-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="space-y-4">
              ...
              <h1 className="text-5xl md:text-7xl font-bold text-gray-900 leading-tight reveal-text">
                Rescue. 
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-600"> Share.</span>
                <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-600"> Serve.</span>
              </h1>
              <p className="text-xl text-gray-600 leading-relaxed max-w-lg reveal-text">
                Transform food waste into community nourishment. Connect with local vendors to rescue surplus food and feed those in need while saving money and the environment.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 reveal-text">
              Why Choose <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-600">LeftOverLift</span>?
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="benefit-card text-center p-6 rounded-xl bg-gradient-to-br from-green-50 to-emerald-50 border border-green-100 hover:shadow-lg transition-all duration-300">
      ...
      {/* Features Section */}
      <section className="features-section py-20 px-6 md:px-20 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 reveal-text">
              How <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-600">LeftOverLift</span> Works
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto reveal-text">
            ...
            {[
              {
                ...
                description: "Vendors quickly upload surplus food with photos, descriptions, and pickup times. Our smart categorization makes listing effortless.",
                icon: "📱",
              ...
              },
              {
                ...
                description: "Users browse real-time listings, filter by location, dietary preferences, and reserve their preferred items instantly.",
                icon: "🔍",
              ...
              },
              {
                ...
                title: "Pickup & Enjoy",
                description: "Seamless pickup process with secure payments, quality assurance, and customer support throughout the experience.",
                icon: "🎉",
                features: ["Secure payments", "Quality guarantee", "24/7 support"]
              }
            ].map((step, index) => (
              <div key={index} className="group relative">
                <div className="feature-card bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-gray-100">
                  <div className="relative mb-6">
                    ...
                    />
                    <div className="absolute -top-4 -right-4 w-12 h-12 bg-gradient-to-r from-green-600 to-emerald-600 rounded-full flex items-center justify-center text-white font-bold text-xl">
                      {index + 1}
                    </div>
                  </div>
      ...
      <section className="testimonials-section py-20 px-6 md:px-20 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 reveal-text">
            ...
            {[
              {
                ...
                quote: "LeftOverLift has transformed how we handle surplus food. We're saving money and helping our community at the same time.",
                rating: 5
              },
              {
                name: "Marcus Johnson",
                ...
                quote: "I love finding amazing deals on quality food while knowing I'm helping reduce waste. The app is incredibly user-friendly.",
                rating: 5
              },
              {
                ...
                quote: "Since using LeftOverLift, we've reduced our food waste by 80% and built stronger connections with our customers.",
                rating: 5
              }
            ].map((testimonial, index) => (
              <div key={index} className="testimonial-card bg-gradient-to-br from-green-50 to-emerald-50 p-8 rounded-2xl border border-green-100">
      ...
      {/* Impact Section */}
      <section className="impact-section py-20 px-6 md:px-20 bg-gradient-to-br from-green-600 to-emerald-700 relative overflow-hidden">
      ...
      {/* FAQ Section */}
      <section className="faq-section py-20 px-6 md:px-20 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 reveal-text">
              Frequently Asked Questions
            </h2>
            <p className="text-xl text-gray-600 reveal-text">
              Everything you need to know about LeftOverLift
            </p>
          </div>

          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <div key={index} className="faq-item bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <button
      ...
      {/* CTA Section */}
      <section className="cta-section py-20 px-6 md:px-20 bg-white">
